...
from chun_nnlib4torch.model.cnn_model import TestConvNet
from torchsummary import summary
from torch.utils.data import DataLoader
from chun_nnlib4torch.train.classifier_train import ClassifierTrainWithSummaryWriter
import yaml
import numpy as np
...
if __name__ == '__main__':
    ...
    dwt_train = ClassifierTrainWithSummaryWriter(dwt_cnn,dataloader,criterion,optimizer_ft,confusion_matrix_name_tuple,epochs=10)
